...
$insert = $db->query(
    "INSERT INTO accounts SET name = '$name', website = '$website', email = '$email', " .
        ...
        "assigned = $assigned, role = $role, enhancer = '$enhancer'"
);

if (!$insert) {
    set_flashdata('error', 'Account gagal ditambahkan.');
} else {
    set_flashdata('success', 'Account berhasil ditambahkan.');
}
